...
cgset -r cpuset.cpus=0-7 app1
cgset -r cpuset.cpus=0-7 app2
cgset -r cpuset.cpus=0-7 app3
cgset -r cpuset.cpus=0-7 app4
cgset -r cpuset.cpus=0-7 app5
cgset -r cpuset.cpus=0-7 app6
cgset -r cpuset.cpus=0-7 app7
cgset -r cpuset.cpus=0-7 app8
...
#echo $PWD
cgexec -g cpuset,freezer:app4 time ./streamcluster 10 20 128 1000000 200000 5000 none output.txt 8 \
